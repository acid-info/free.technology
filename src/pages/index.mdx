...
<Home>
    <Hero>
        # Institute of Free Technology<sup>©</sup>
    ...
    <Portfolio>
        ...
        <PortfolioItem mark="/icons/bu/status-network.svg" title="Status Network">

            | Development Status  | Vertical     |
            |--------------------|---------------|
            | {BU_DATA['status-network'].hero.devStatus}     | {BU_DATA['status-network'].hero.vertical}  |

            | Founded | Achievements |
            |--------------------|---------------|
            | {BU_DATA['status-network'].hero.est} | {BU_DATA['status-network'].hero.achievements} |

            <p>{BU_DATA['status-network'].hero.description}</p>

            <Link href="/status-network"><Button width="150px" height="40px" color="black">Learn more</Button></Link>
        </PortfolioItem>
    ...
    <Mission title="Mission">
        ...
        <div>
            <p>The Institute of Free Technology emerged from Status, which Jarrad Hope and Carl Bennetts founded to enable the free flow of information and protect the right to private, secure conversations in 2017.</p>
