...
const content = `# IFT Studio Website Terms of Use
...
The laws of Singapore governs these Website Terms of Use and any disputes between you and us, whether in court or arbitration, without regard to conflict of laws provisions.
...
If we and you are unable to further resolve this dispute within sixty (60) calendar days of us receiving this notice of dispute, then any such dispute will be referred to and finally resolved by the Parties through arbitration administered by the Singapore International Arbitration Centre in accordance with the Arbitration Rules of the Singapore International Arbitration Centre for the time being in force, which rules are deemed to be incorporated herein by reference, and the arbitral decision may be enforced in any court. The seat of the arbitration shall be Singapore, the tribunal shall consist of one arbitrator, all proceedings shall be kept confidential and the language of the arbitration shall be English. Payment of all relevant fees in respect of the arbitration, including filing, administration and arbitrator fees will be in accordance with the Arbitration Rules of the Singapore International Arbitration Centre. 
