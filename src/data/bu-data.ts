const BU_DATA: any = {
  ...
  'status-network': {
    hero: {
      ...
      est: '2024',
      devStatus: 'In development',
      vertical: 'Ethereum Layer 2',
      founders: 'Jarrad Hope, Carl Bennetts',
      achievements:
        'Partnership with Linea (2024), private testnet (2024), yield-bearing bridge and spam protection PoC (2025), public testnet (2025), public mainnet (2026)',
      description:
    ...
    about: {
      description:
        'Status Network is the first natively gasless Ethereum Layer 2 that provides built-in public funding for builders and liquidity providers, and ensures sustainability via native yield-bearing mechanisms. The network, which will be seamlessly integrated with the Status app and other IFT protocols, is deployed using the Linea stack and is the public execution layer of the IFT.\n\nUsers transacting on Status Network receive Karma – a non-transferable governance token – which rewards them with greater influence in the allocation of native yield and fees generated by the network’s apps. This enables the Status Network to fund projects building on it, provide enhanced liquidity incentives, and allow users to transact without paying gas fees.\n\nKarma also acts as a sybil-resistant tiering mechanism for gasless usage. Higher Karma unlocks higher free transaction throughput. Users who exceed their quota must pay a premium or risk Karma slashing, with the Vac-developed Rate-Limiting Nulifier protocol mitigating spam at the sequencer level.\n\nStatus Network works closely with the value-aligned Linea ecosystem. It launched the first external testnet on the Linea stack in December 2024 and is the first external contributor to the Linea codebase. The two projects are currently collaborating on the native yield module, gasless module, and a generalised data availability scaling solution.\n\nDeeply integrated with the IFT technology stack – Waku for messaging, Codex for storage, Nimbus for clients, and Status Wallet and Keycard for access – Status Network is a new public utility for building and funding meaningful onchain software. It is radically free to use and governed by merit.',
    },
    milestones: [
      {
        year: '2024',
        title: 'Partnership with Linea',
      },
      {
        year: '2025',
        title: 'Yield-bearing bridge and spam protection PoC',
      },
      {
        year: '2025',
